...
Um [protótipo de baixa fidelidade](./redesign_artefacts/low_fidelity_prototype) é aquele que não se assemelha muito ao produto final; ele utiliza, por exemplo, materiais muito diferentes da versão final pretendida, como papel e cartolina, em vez de telas eletrônicas e metal. Uma impressora feita de caixa de papelão é um bom exemplo de protótipo de baixa fidelidade.
